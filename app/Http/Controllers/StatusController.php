...
class StatusController extends Controller
{
    ...
    public function update(Request $request, Status $status)
    {
        ...
        return redirect()->route('statuses.index')->with('pesan',"Pendidikan $status->nama_status berhasil diubah");
    ...
    {
        $status->delete();
        return redirect()->route('statuses.index')->with('pesan', "Pendidikan $status->nama_status berhasil dihapus");
    }
}
