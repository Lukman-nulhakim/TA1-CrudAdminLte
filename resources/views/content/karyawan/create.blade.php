                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" placeholder="Nama" autocomplete="off" value="{{ old('nama') }}">
                                        @error('nama')
                                            {{ $message }}
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-6 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_telepon" id="no_telepon" class="form-control @error('no_telepon') is-invalid @enderror" placeholder="No Telepon" autocomplete="off" value="{{ old('no_telepon') }}">
                                        @error('no_telepon')
                                            {{ $message }}
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select @error('nama_pendidikan') is-invalid @enderror" name="pendidikan_id" id="pendidikan_id">
                                            @foreach ($pendidikans as $pendidikan)
                                                <option value="{{ $pendidikan->id }}" {{ old('pendidikan_id') == $pendidikan->nama_pendidikan ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select @error('nama_status') is-invalid @enderror" name="status_id" id="status_id">
                                            @foreach ($statuses as $status)
                                                <option value="{{ $status->id }}" {{ old('status_id') == $status->nama_status ? 'selected' : '' }}>
                                                    {{ $status->nama_status }}
                                                </option>
                                            @endforeach
                                        </select>
